          ...
          <div className="overflow-x-auto rounded-xl bg-dark-100 border border-gray-800">
            <table className="w-full text-sm">
              <thead className="border-b border-gray-700">
                <tr><th className="p-3 text-right">الوكيل</th><th className="p-3 text-right">نسبة العمولة (%)</th><th className="p-3 text-right">آخر تحديث</th><th className="p-3 text-right"></th></tr>
              </thead>
              <tbody>
                {commissions.map(c => (
